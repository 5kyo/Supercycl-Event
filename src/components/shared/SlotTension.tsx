      ...
      <div className="relative">
        ...
        >
          <span
            style={{
              color: cfg.color,
              textShadow: stage === 'none' ? 'none' : `0 0 20px ${cfg.glow}`,
          ...
          >
            <div
              style={{
                ...
                boxShadow: stage === 'none' ? 'none' : `0 0 12px ${cfg.glow}`,
                transition: 'width 800ms cubic-bezier(0.22, 1, 0.36, 1), background 600ms ease',
              }}
            />
          </div>
        )}
