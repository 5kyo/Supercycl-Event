...
| 5 | 거래소 | 현재 가장 많이 쓰는 거래소 3곳 | 다중 (Bybit/OKX/Bitget/Binance/기타) |
| 6 ⭐ | 2x 레버리지 | 다른 거래소 평균 사용 레버리지 | 단일 (2x/3x/5x/10x+/직접 입력) |
| 7 ⭐ | 2x 레버리지 | 2x 제한이 Supercycl 사용에 영향을 미치나요 | 5점 척도 |
| 8 ⭐ | 2x 레버리지 | 2x 제한 있어도 쓸 의향이 있다면 그 이유 | 다중 |
| 9 | 인지 | Supercycl을 어떻게 알게 되었나요 | 단일 |
| 10 | 프로필 | 월평균 크립토 거래 금액대 (익명 보장) | 단일 (구간) |
