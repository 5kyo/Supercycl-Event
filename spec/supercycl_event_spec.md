...
| 8 ⭐ | 2x 레버리지 | Supercycl의 2x 제한에 대한 본인의 입장 | 다중 (리스크 관리/시그널 품질/이용 안 함/기타) |
| 9 | 인지 | Supercycl을 어떻게 알게 되었나요 | 단일 |
| 10 | 프로필 | 월평균 크립토 거래 금액대 | 단일 (구간) |
| 11 | 시그널 개인화 | 관심 자산 카테고리 | 다중 (BTC/ETH/Alt/Meme/RWA) |

> 📌 **변경 이력**:
> - **이전 13문항 → 12문항** (커밋 `48609f2`): Q1 재설계, 신뢰 영역 단독 문항 제거, 번호 시프트
> - **12문항 → 11문항**: 가치제안 단일 문항(Supercycl을 쓴다면 가장 매력적인 기능 — 시그널 품질/차트/거래소 통합/수수료/리워드) 제거. 가치제안 신호는 Q1(만족) 다중 선택지로 흡수
